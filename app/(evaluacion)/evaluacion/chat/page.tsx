...
const ESCENARIOS_INFO = [
  {
    ...
    key: 'libre',
    label: 'Sin escenario',
    desc: 'Conversación libre sin objetivo asignado.',
  },
  {
    id: 1,
    key: '1',
    label: 'E1 · Selección guiada',
    desc: 'Busca una actividad para 5.º Primaria, Matemáticas y participación femenina.',
  },
  {
    id: 2,
    key: '2',
    label: 'E2 · Adaptación',
    desc: 'Adapta una actividad de Secundaria para 6.º Primaria manteniendo el enfoque de inclusión.',
  },
  {
    id: 3,
    key: '3',
    label: 'E3 · Apoyo formativo',
    desc: 'Pide que el agente explique contenido técnico fuera de tu dominio.',
  },
  {
    id: 4,
    key: '4',
    label: 'E4 · Fuera de alcance',
    desc: 'Prueba los límites del sistema con consultas probablemente fuera del repositorio.',
  },
  {
    id: 5,
    key: '5',
    label: 'E5 · Exploración libre',
    desc: '~10 minutos de interacción no guiada, como lo haría un docente real.',
  },
]
...
export default function EvaluacionChatPage() {
  ...
  // Cambia de escenario guardando la conversación actual en caché
  ...
  async function reiniciarEscenario() {
    ...
    const label = ESCENARIOS_INFO.find(s => s.key === key)?.label ?? 'esta conversación'
    if (!window.confirm(`¿Reiniciar "${label}"?\nSe borrarán todos los mensajes de este escenario.`)) return
              ...
              <div className="space-y-5 pt-6">
                <div className="text-center">
                  <p className="text-base font-medium text-gray-800 mb-1">
                    ¡Hola{nombreDocente ? `, ${nombreDocente}` : ''}!
                  </p>
